...
class LoansController extends ResourceController
{
    ...
    {
        $loanModel = new \App\Models\LoanModel(); // sesuaikan nama model kamu
        $data['loans'] = $loanModel->getAllWithDetails(); // ambil semua data pinjaman + relasi jika ada
        return view('View/loans/print', $data);
    }
}
